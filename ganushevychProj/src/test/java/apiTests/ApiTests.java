    ...
    public void getAllPostsByUser(){
       PostDTO[] responseBody = given()
               ...
               .filter(new AllureRestAssured())
                ...
                .log().all()
                .extract()
                .response().as(PostDTO[].class); //распаковка риспонса в тип даних ПостДТО
...
//                new PostDTO("New post from API Taras 2", "post body", "One Person"
//                        , new AuthorDTO("sasha"), false),
//                new PostDTO("New post from API Taras", "post body", "One Person"
//                        , new AuthorDTO("sasha"), false),
//                new PostDTO("First", "bla bla", "All Users"
//                        , new AuthorDTO("sasha"), false)
    ...
    public void getAllPostsByUserPath(){
        ...
        for (int i = 0; i < actualAuthorList.size(); i++) {
            softAssertions.assertThat(actualAuthorList.get(i).get("username")).as("Item number " + i)
                    .isEqualTo(USER_NAME);
        }
