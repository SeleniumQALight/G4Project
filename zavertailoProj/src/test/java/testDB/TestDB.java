...
//
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable  where login = 'G4_OlgaZ'"));
//        int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES (741, 'G4_OlgaZ', 'qwerty')");
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable  where login = 'G4_OlgaZ'"));
