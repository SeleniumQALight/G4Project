...
//                new PostDTO("test2", "test body2", "All Users", new AuthorDTO("autoapi"), false)
    ...
    public void getAllPostsByUserNegative(){
        ...
        Assert.assertEquals("Message in responce ", "\"Sorry, invalid user requested.undefined\"", actualResponse);
        Assert.assertEquals("Message in responce ", "Sorry, invalid user requested.undefined", actualResponse.replace("\"",""));
