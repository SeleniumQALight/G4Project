...
public class RegistrationTestsWithExcel extends BaseTest {
    String login, email, password, expectedErrors;

    public RegistrationTestsWithExcel(String login, String email, String password, String expectedErrors) {
        this.login = login;
        this.email = email;
