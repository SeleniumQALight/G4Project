...
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4Ivan'"));
//        int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES (999, 'G4Ivan','password1')");
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4Ivan'"));
