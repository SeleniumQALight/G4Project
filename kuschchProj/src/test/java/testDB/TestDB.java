...
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4Kuschch'"));
//        int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES(777, 'G4Kuschch', 'pass')");
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4Kuschch'"));
