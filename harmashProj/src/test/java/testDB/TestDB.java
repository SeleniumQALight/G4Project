...
public class TestDB {
    ...
    public void testDataFromDataBase() throws SQLException {
        ...
        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4FA'"));

        int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES(909, 'G4FA', 'FApass')");
        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4FA'"));
