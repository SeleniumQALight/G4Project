...
//        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4Nadia'"));
//        int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES(1231, 'G4Nadia', 'pass321')");
