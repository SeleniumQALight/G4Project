...
public class RegTestWithPageObjectWithExcel extends BaseTest {
    String login, email,password,  expectedErrors;

    public RegTestWithPageObjectWithExcel(String login, String email, String password, String expectedErrors) {
        this.login = login;
        this.email = email;
