...
public class CheckCurrencyRatesWithPrivatFront {
    ...
    public void getExchangeRates(){
        ...
        for (int i = 0; i < responseBody.length; i++) {
            currencyRatesSale.put("Sale of " + responseBody[i].getCcy(), responseBody[i].getSale());
            currencyRatesBuy.put("Buy of " + responseBody[i].getCcy(), responseBody[i].getBuy());
        }

        System.out.println("Sale course of " + currencyRatesSale);
        System.out.println(currencyRatesBuy);
    }
}
