...
public class NotValidLogin {
    WebDriver driver;

    @Test
    public void notValidLogIn() {

//        Ne mogu vvesti dannie. V console pishet chto tolyko dlya chteniya
//        System.out.println("Please enter not valid login: ");
//        String login = LoginAndPasswordEnter.loginEnter() ;
//        System.out.println("Please enter some password: ");
//        String pass = LoginAndPasswordEnter.passEnter();
        ...
        Assert.assertTrue("Button 'Sign up for OurApp' not displayed",buttonSignInDisplayed());
    ...
    private boolean buttonSignInDisplayed(){
        try {
