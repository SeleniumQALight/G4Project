...
//    String expectedErrors = "Username must be at least 3 characters.;You must provide a valid email address.;Password must be at least 12 characters.";
    ...
    @Parameters({
            ...
            , "tr,test@qqqq.com,123456qwert,Username must be at least 3 characters."
            , "tr,qqq,123456qwert,Username must be at least 3 characters.;You must provide a valid email address."
    })
