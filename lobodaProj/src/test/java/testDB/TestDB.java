...
public class TestDB {
    ...
    public void testDataFromDataBase() throws SQLException {
        ...
        System.out.println(mysqlDataBase.selectTableAsMap("select * from seleniumTable where login = 'G4loboda'"));
        //int numberOfRows = mysqlDataBase.changeTable("INSERT INTO seleniumTable VALUES(1818, 'G4loboda', 'passloboda')");
