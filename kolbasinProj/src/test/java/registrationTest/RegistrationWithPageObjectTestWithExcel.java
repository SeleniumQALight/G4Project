...
public class RegistrationWithPageObjectTestWithExcel extends BaseTest {
    String login,  email,  password,  expectedErrors;

    public RegistrationWithPageObjectTestWithExcel(String login, String email, String password, String expectedErrors) {
        this.login = login;
        this.email = email;
