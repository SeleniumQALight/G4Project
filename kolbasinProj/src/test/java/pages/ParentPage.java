...
//        PageFactory.initElements(webDriver, this); // инициализирует элементы для выбранной страницы(пейджи)
    ...
    abstract String getRelativeUrl();  // заставим все странички возвращать урлу
    ...
    protected void waitChatTobeHide(){
        webDriverWait10
                .withMessage("Chat is no closed")  // выведется это сообщение если не дождались элемента
                .until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(".//*[@id='chat-wrapper']")));

        //TODO wait chat
//        try {
//            Thread.sleep(1000);
//        } catch (InterruptedException e) {  // было ожидание такое
//            e.printStackTrace();
//        }
    }
